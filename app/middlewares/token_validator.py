...
async def access_control(request: Request, call_next):
    ...
    try:
        if url.startswith("/api"):
            ...
            cookies["Authorization"] = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwiZW1haWwiOiJ5dGgxMTMzQGdtYWlsLmNvbSIsIm5hbWUiOm51bGwsInBob25lX251bWJlciI6bnVsbCwicHJvZmlsZV9pbWciOm51bGwsInNuc190eXBlIjpudWxsfQ.9HnwtLgETDtq7F6zm0EM82r0RJBWtGtH_BWnCPcGrZk"
